 ...
 * Version: 0.7.17
 * Author: Draggable https://draggable.ioh
 */
! function(e) {
    function t(r) {
    ...
    var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
        ...
        DOM = function() {
            ...
            return DOM.prototype.processTagName = function(e) {
                ...
                var t = document.getElementById("f-i-" + e);
                return t ? '<svg class="svg-icon f-i-' + e + '"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#f-i-' + e + '"></use></svg>' : '<span class="glyphicon glyphicon-' + e + '" aria-hidden="true"></span>'
                ...
                set: function(e) {
                    var t = this,
                        ...
                        s = {
                            rows: {
                                actionButtons: {
                                    buttons: [(0, _utils.clone)(n), i, l, a],
                                    order: [],
                                    disabled: []
                                }
                            },
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.registeredFields = t.formData = t.data = void 0;
    var n, i = o(5),
        a = r(i),
        l = o(1),
        s = r(l),
        ...
        p = {
            ...
            saveOrder: function(e, t) {
                return {
                    row: p.saveRowOrder,
                    column: p.saveColumnOrder,
                    field: p.saveFieldOrder,
                    options: p.saveOptionOrder
                }[e](t)
            },
            ...
            save: function() {
                ...
                var r = function() {
                    ...
                    return o && u.opts.sessionStorage && o.setItem("formData", p.json), u.opts.debug && console.log("Saved: " + e), a.default.formeoSaved = new CustomEvent("formeoSaved", {
                        detail: {
                            formData: p.js
                        }
                    }), document.dispatchEvent(a.default.formeoSaved), n
                };
    ...
    var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
        ...
        a = (t.match = function() {
            ...
            for (var o = t.replace(".", "");
                (e = e.parentElement) && !e.classList.contains(o););
            return e
        }, t.closestFtype = function(e) {
            for (;
                (e = e.parentElement) && !e.fType;);
            return e
        }, t.unique = function(e) {
                ...
                return e.prototype.getValue = function(e) {
                    ...
                    if (t && a)
                        if ("object" === (void 0 === t ? "undefined" : n(t)))
                            for (var l = 0; l < a.length; l++) o = a[l].substring(1, a[l].length - 1), i = i.replace(r.makeSafe(a[l]), t[o] || "");
                    ...
                    var e = o(regeneratorRuntime.mark(function e() {
                        var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "pt-BR";
    ...
    ! function(i) {
        ...
        var v, y, w, x, _, E, D, k, C, O, T, S, N, M, L, A, j, I = {},
            P = /\s+/g,
            ...
            X = h(function(e, t, o) {
                if (o && t.scroll) {
                    var r, n, i, a, l = t.scrollSensitivity,
                        s = t.scrollSpeed,
                        d = e.clientX,
                        f = e.clientY,
                        c = window.innerWidth,
        ...
        return e.prototype = {
            ...
            _appendGhost: function() {
                if (!w) {
                    var e, t = v.getBoundingClientRect(),
                        o = l(v),
                        r = this.options;
            ...
            _onDragOver: function(e) {
                ...
                if (void 0 !== e.preventDefault && (e.preventDefault(), !s.dragoverBubble && e.stopPropagation()), j = !0, M && !s.disabled && (m ? g || (i = !_.contains(v)) : M.pull && c && (M.name === d.name || c.indexOf && ~c.indexOf(M.name))) && (void 0 === e.rootEl || e.rootEl === this.el)) {
                    ...
                    if (0 === a.children.length || a.children[0] === w || a === e.target && (r = p(a, e))) {
                        ...
                        var h, b = r.getBoundingClientRect(),
                            D = b.right - b.left,
                            k = b.bottom - b.top,
                            ...
                            A = .5 < (S ? (e.clientX - b.left) / D : (e.clientY - b.top) / k),
            ...
            return e.prototype.resizePanels = function() {
                ...
                var l = {
                        ...
                        attrs: {
                            ...
                            title: a.default.get("controlGroups.nextGroup"),
                            type: "button"
                        },
                        dataset: {
                            toggle: "tooltip",
                    ...
                    s = {
                        ...
                        attrs: {
                            ...
                            title: a.default.get("controlGroups.prevGroup"),
                            type: "button"
                        },
                        dataset: {
                            toggle: "tooltip",
                ...
                return o.refresh = function(e) {
                    void 0 !== e && (a = e, s(e)), t.resizePanels(), l = {
                        nav: n.offsetWidth * a,
                        panel: r.offsetWidth * a
                    }, d(l)
                }, o.nextGroup = function() {
                    var t = a + 1;
                    if (t !== i.length) l = {
                        nav: n.offsetWidth * t,
                        panel: r.offsetWidth * t
                    }, d(l), s(t), a++;
                    else {
                        var o = {
                            nav: n.style.transform,
                            panel: r.style.transform
                        };
                        l = {
                            nav: n.offsetWidth * a + 10,
                            panel: r.offsetWidth * a + 10
    ...
    var a = o(4),
        ...
        _ = function() {
                        ...
                        i18n: {
                            ...
                            preloaded: {
                                "pt-BR": {
                                    ...
                                    "attrs.valid": "Campo Obrigatório",
                                    "attrs.autoHeight": "Altura Automática",
                                    "attrs.exLabel": "Rótulo",
                                    "attrs.format": "Formato",
                                    "attrs.valid-type": "Tipo de validação",
                                    "attrs.equalto": "Confirmar",
                                    "attrs.mequal": "Mensagem de Confirmação",
                                    "placeholder.data-group": "O mesmo nome do campo antes das []",
                                    "attrs.data-group": "Grupo de campos",
                                    "attrs.type": "Tipo",
                                    "attrs.input-type": "Tipo de Entrada",
                                    "attrs.rows": "Linhas",
                                    "attrs.id": "ID",
                                    "attrs.title": "Título",
                                    "attrs.style": "Estilo",
                                    "attrs.placeholder": "Marcador de Posição",
                                    "attrs.data-mask": "Máscara",
                                    "attrs.name": "Nome",
                                    "attrs.data-minlength": "Comprimento Mínimo",
                                    "attrs.maxlength": "Comprimento Máximo",
                                    "attrs.dir": "Direção",
                                    ...
                                    confirmClearAll: "Tem certeza de que deseja limpar todos os campos?",
                                    content: "Conteúdo",
                                    control: "Controle",
                                    ...
                                    "panelLabels.config": "Configuração",
                                    "panelLabels.meta": "Metadados",
                                    "panelLabels.options": "Opções",
                                    paragraph: "Parágrafo",
                                    placeholder: "Marcador de Posição",
                                    "placeholder.className": "Classes Separadas por Espaço",
                                    "placeholder.name": "Nome",
                                    "placeholder.input-type": "Tipo de Entrada",
                                    "placeholder.rows": "Linhas",
                                    "placeholder.data-minlength": "Comprimento Mínimo",
                                    "placeholder.maxlength": "Comprimento Máximo",
                                    "placeholder.email": "Digite seu e-mail",
                                    "placeholder.label": "Rótulo",
                                    "placeholder.password": "Digite sua senha",
                                    "placeholder.placeholder": "Marcador de Posição",
                                    "placeholder.text": "Digite algum Texto",
                                    "placeholder.textarea": "Digite muito texto",
                                    "placeholder.value": "Valor",
                                    "placeholder.data-mask": "99/99/9999",
                                    preview: "Visualização",
                                    primary: "Primário",
                                    radio: "Botão de Rádio",
                                    radioGroup: "Grupo de Botões de Rádio",
                                    remove: "Remover",
                                    ...
                                    roles: "Acesso",
                                    row: "Linha",
                                    "row.makeInputGroup": "Transformar esta linha em um grupo de entrada.",
                                    "row.makeInputGroupDesc": "Grupos de Entrada permitem aos usuários adicionar conjuntos de entradas de uma só vez.",
                                    "row.settings.fieldsetWrap": "Agrupar linha em uma tag <fieldset>",
                                    "row.settings.fieldsetWrap.aria": "Agrupar Linha em Fieldset",
                                    save: "Salvar",
                                    ...
                                    "sizes.m": "Padrão",
                                    "sizes.sm": "Pequeno",
                                    "sizes.xs": "Muito Pequeno",
                                    style: "Estilo",
                                    styles: "Estilos",
                                    "styles.btn": "Estilo do Botão",
            ...
            return e.prototype.loadResources = function() {
                ...
                }), u.default.formeoLoaded = new CustomEvent("formeoLoaded", {
                    detail: {
                        formeo: w
                    }
                ...
                if (e) {
                    ...
                    if (!isNaN(e.length)) {
                        var o = -1,
                            r = function t() {
                                for (; ++o < e.length;)
                                    if (v.call(e, o)) return t.value = e[o], t.done = !1, t;
            ...
            a.prototype = O.constructor = l, l.constructor = a, a.displayName = "GeneratorFunction", x.isGeneratorFunction = function(e) {
                ...
                finish: function(e) {
                    for (var t, o = this.tryEntries.length - 1; 0 <= o; --o)
                        if (t = this.tryEntries[o], t.finallyLoc === e) return this.complete(t.completion, t.afterLoc), p(t), C
                },
                catch: function(e) {
                    for (var t, o = this.tryEntries.length - 1; 0 <= o; --o)
            ...
            function e(t) {
                ...
                var l = {
                    ...
                    f = {
                        ...
                        id: r.columnID,
                        content: [g.default.actionButtons(r.columnID), {
                            tag: "li",
                ...
                return g.default.columns.set(i, {
                    column: f,
                    sortable: u
                }), f
            }
    ...
    var i = o(6),
        ...
        //Controles inputs
    t.Controls = function() {
        function validacoes(s){
            return {
                "valid-type": 
                [{
                    label: s.default.get("nenhum"),
                    value: "0"
                    },{
                    label: s.default.get("email"),
                        value: "email"
                    },{
                    label: s.default.get("cpf"),
                        value: "cpf"
                }]
            }
        }

        function essencialAttrs(s){
            return {
                "data-group":"",
            }
        }
        function e(t, o) {
            ...
            var l = [{
                ...
                attrs: {
                    type: "text",
                    exLabel: [{
                        label: s.default.get("exibir"),
                        value: "1"
                    },{
                    label: s.default.get("ocultar"),
                        value: "0"
                    }],
                    className: "",
                    name: "",
                     "input-type": [{
                        label: s.default.get("textType"),
                        value: "text"
                    },{
                    label: s.default.get("tel"),
                        value: "tel"
                    },{
                    label: s.default.get("password"),
                        value: "password"
                    }],
                    placeholder: '',
                    "data-mask": '',
                    valid: [{
                        label: s.default.get("desativar"),
                        value: "0"
                    },{
                    label: s.default.get("ativar"),
                        value: "1"
                    }],
                    ...validacoes(s),
                    ...essencialAttrs(s),
                ...
                config: {
                    disabledAttrs: ["type"],
                    label: s.default.get("input.text")
                },
                meta: {
                    group: "common",
                    icon: "text-input",
                ...
                config: {
                    disabledAttrs: ["type"],
                    label: s.default.get("input.date")
                },
                meta: {
                    group: "common",
                    icon: "calendar",
                ...
                options: [{
                    ...
                    type: [{
                        ...
                        label: s.default.get("submit"),
                        value: "submit"
                    }],
                    className: [{
                        label: s.default.get("default"),
                        value: "",
                        selected: !0
                    }, {
                        ...
                        label: s.default.get("danger"),
                        value: "error"
                    }, {
                        label: s.default.get("success"),
                        value: "success"
                    }, {
                        label: s.default.get("warning"),
                        value: "warning"
                    }]
                }]
            }, {
                ...
                options: [1, 2, 3, 4].map(function(e) {
                    return {
                        label: s.default.get("labelCount", {
                            label: s.default.get("option"),
                            count: e
                        }),
                        value: "option-" + e,
                        selected: !1
                ...
                config: {
                    label: s.default.get("checkbox") + "/" + s.default.get("group"),
                    disabledAttrs: ["type"]
                },
                meta: {
                    group: "common",
                ...
                config: {
                    label: s.default.get("radioGroup"),
                    disabledAttrs: ["type"]
                },
                meta: {
                    group: "common",
                ...
                attrs: {
                    ...
                    [{
                        ...
                        label: s.default.get("file"),
                            value: "file"
                    }]
                },
                config: {
                    disabledAttrs: ["type"],
                    label: s.default.get("fileUpload")
                },
                meta: {
                    group: "common",
                    icon: "upload",
            ...
            this.defaults = {
                ...
                groups: [{
                    ...
                    id: "html",
                    label: s.default.get("htmlElements"),
            ...
            return o = c.default.orderObjectsBy(o, this.groupOrder, "id"), o = o.filter(function(e) {
                ...
                var a = {
                    ...
                    attrs: {
                        ...
                        id: t.formID + "-" + o[i].id + "-control-group"
                    },
                    fType: "controlGroup",
                    config: {
                        label: o[i].label || ""
        ...
        w = function() {
            function e(t) {
                ...
                var n = {
                    tag: "li",
                    attrs: {
                        className: "stage-fields field-type-" + r.meta.id
                    },
                    id: o.fieldID,
                    content: [h.default.actionButtons(o.fieldID, "field"), o.fieldEdit()],
                    panelNav: o.panelNav,
                    dataset: {
                        hoverTag: l.default.get("field")
                    },
                    fType: "fields",
                    action: {
                        mouseenter: function() {
            ...
            return e.prototype.updatePreview = function() {
                ...
                if (n[e]) {
                    o = {
                        tag: "ul",
                        attrs: {
                            className: ["field-edit-group", "field-edit-" + e]
                        },
                        editGroup: e,
                ...
                var i = (0, y.uuid)(),
                    ...
                    l = {
                        ...
                        content: t.editPanelInputs(r, a, o, i)
                    },
                    d = {
                        tag: "li",
                        className: [o + "-" + r + "-wrap", "prop-wrap"],
                        id: i,
                        content: []
                    },
                    c = {
                ...
                return {
                    ...
                    content: [{
                        ...
                        action: {
                            click: function(o) {
                                var r = {
                                    btnCoords: h.default.coords(o.target)
                                };
                ...
                u.default.forEach(i, function(r) {
                    ...
                    if (u.default.inArray(i, o)) {
                        var a = {
                            tag: "div",
                            attrs: {
                                className: "f-panel " + r + "-panel"
                            },
                            config: {
                                label: l.default.get("panelLabels." + r) || ""
                            },
        ...
        h = function() {
            function e(t) {
                ...
                m.formData.rows.set(a, p.default.merge(o, s)), r = {
                    ...
                    dataset: {
                        hoverTag: l.default.get("row"),
                        editingHoverTag: l.default.get("editing.row")
                    },
                    id: a,
            ...
            return e.prototype.onSort = function(e) {
                ...
                get: function() {
                    var e = this,
                        ...
                        r = {
                            tag: "label",
                            content: l.default.get("row.settings.fieldsetWrap")
                        },
                        n = {
                            tag: "input",
                            id: e.rowID + "-fieldset",
                        ...
                        i = {
                            ...
                            config: {
                                label: l.default.get("row.makeInputGroup"),
                                description: l.default.get("row.makeInputGroupDesc")
                            }
                        },
                        a = {
                            tag: "input",
                    ...
                    var d = Object.assign({}, r, {
                        ...
                        u = {
                            tag: "div",
                            className: "col-sm-8",
                            content: c.default.columnPresetControl(e.rowID)
                        },
                        //#modificar - local onde adiciona row onde edita linha, onde coloca as colunas custom, ou selecionar
                        p = c.default.formGroup([f, u], ""); //removido o nome row
            ...
            function e(t, o) {
                ...
                var r = {
                    formSettings: [{
                        ...
                        config: {
                            label: d.default.get("Form Title")
                        }
                    }, {
                        tag: "input",
                        id: "form-novalidate",
                        ...
                        config: {
                            label: d.default.get("Form novalidate")
                        }
                    }, {
                        tag: "input",
                        id: "form-tags",
    ...
    "string" == typeof r && (r = [
        [e.i, r, ""]
    ]), o(21)(r, {}), r.locals && (e.exports = r.locals)
}, function(e) {
    function t() {
    ...
    function o(e) {
        for (var t = [], o = {}, r = 0; r < e.length; r++) {
            ...
            o[i] ? o[i].parts.push(d) : t.push(o[i] = {
                id: i,
                parts: [d]
            })
        }
