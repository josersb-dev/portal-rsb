...
class Connector
{
	 ...
	 */
	public function putObject(Input $input, string $bucket, string $uri, string $acl = Acl::ACL_PRIVATE, array $requestHeaders = [], $mimeType = ''): void
	{
		...
		//#melhorias $request->setHeader('Content-Type', $input->getType());
