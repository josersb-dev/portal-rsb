...
$logoBrandLarge  = $this->params->get('logoBrandLarge')
    ...
    : Uri::root(false) . 'media/templates/administrator/rsb/images/logos/brand-large.svg';
$logoBrandSmall = $this->params->get('logoBrandSmall')
    ? Uri::root(false) . htmlspecialchars($this->params->get('logoBrandSmall'), ENT_QUOTES)
    : Uri::root(false) . 'media/templates/administrator/rsb/images/logos/brand-small.svg';
...
$loginLogo = $this->params->get('loginLogo')
    ...
    : Uri::root(false) . 'media/templates/administrator/rsb/images/logos/login.svg';
