...
if(isset($_GET['rsbAdmin'])){
    $_SESSION['rsbLoginAdmin'] = uniqid();
}

if(!isset($_SESSION['rsbLoginAdmin'])){
...
$logoBrandLarge  = $this->params->get('logoBrandLarge')
    ...
    : Uri::root(false) . 'media/templates/administrator/rsb/images/logos/oficial.webp';
    ...
    <div id="wrapper" class="wrapper flex-grow-1">
        ...
        <div id="sidebar-wrapper" class="sidebar-wrapper px-3 pb-3">
            <div id="main-brand" class="main-brand">
                ...
                <h2><?php echo Text::_('Administração Login'); ?></h2>
            </div>
            <div id="sidebar">
