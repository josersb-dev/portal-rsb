...
class ItemModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	protected $text_prefix = 'COM_NOTICIAS';
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_noticias.item';
	...
	*/
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_noticias.edit.item.data', array());
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_noticias'))
		{
