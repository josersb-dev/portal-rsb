...
class miniorangeoauthControllerAccountSetup extends JControllerForm
{
    ...
    function saveConfig() { 
        ...
        $this->setRedirect('index.php?option=com_miniorange_oauth&view=accountsetup&moAuthAddApp='.$post['moOauthAppName'],JText::_('COM_MINIORANGE_OAUTH_CONFIGURATION_SAVED_SUCCESSFULLY_PERFORM_TEST_CONFIG') );
    }
    ...
    function saveMapping(){
        ...
        $this->setRedirect('index.php?option=com_miniorange_oauth&view=accountsetup&tab-panel=configuration',JText::_('COM_MINIORANGE_OAUTH_ATTRIBUTE_MAPPING_SAVED_SUCCESSFULLY') );
    }
