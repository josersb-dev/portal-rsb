...
namespace Rsbnoticias\Component\Noticias\Administrator\View\Item;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_NOTICIAS_TITLE_ITEM'), "generic");
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			ToolbarHelper::versions('com_noticias.item', $this->item->id);
		}
