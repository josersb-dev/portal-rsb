 ...
 * @since  1.0.0
 */
class EbookModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	protected $text_prefix = 'COM_RSBEBOOK';
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_rsbebook.ebook';
	...
	*/
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_rsbebook.edit.ebook.data', array());
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_rsbebook'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__rsbebook');
				$max             = $db->loadResult();
