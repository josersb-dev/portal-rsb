...
{
	/**
	 * Method to clone existing Ebooks
	 *
	 * @return  void
	 *
	 * @throws  Exception
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_rsbebook&view=ebooks');
	}
	 ...
	 * @since   1.0.0
	 */
	public function getModel($name = 'Ebook', $prefix = 'Administrator', $config = array())
	{
