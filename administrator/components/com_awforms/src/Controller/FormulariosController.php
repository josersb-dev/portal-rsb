...
/**
 * Formularios list controller class.
 *
 * @since  1.0.0
 */
class FormulariosController extends AdminController
{
	/**
	 * Method to clone existing Formularios
	 *
	 * @return  void
	 *
	 * @throws  Exception
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_awforms&view=formularios');
	}
	 ...
	 * @since   1.0.0
	 */
	public function getModel($name = 'Formulario', $prefix = 'Administrator', $config = array())
	{
