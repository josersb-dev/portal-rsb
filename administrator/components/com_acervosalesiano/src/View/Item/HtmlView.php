...
namespace Acervosalesiano\Component\Acervosalesiano\Administrator\View\Item;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_ACERVOSALESIANO_TITLE_ITEM'), "generic");
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			ToolbarHelper::versions('com_acervosalesiano.item', $this->item->id);
		}
