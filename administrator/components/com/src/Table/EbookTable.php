...
namespace Rsbebook\Component\Rsbebook\Administrator\Table;
// No direct access
 ...
 * @since 1.0.0
 */
class EbookTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_rsbebook.ebook';
		parent::__construct('#__rsbebook', 'id', $db);
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_rsbebook.ebook.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_rsbebook/access.xml',
				"/access/section[@name='ebook']/"
			);
			$default_actions = Access::getAssetRules('com_rsbebook.ebook.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetParentId($table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_rsbebook');
