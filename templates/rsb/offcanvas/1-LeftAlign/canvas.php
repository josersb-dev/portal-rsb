	...
	<div class="offcanvas-inner">
		...
		<div class="sp-module ">
			<div class="sp-module-content">
				<ul class="menu menu-sistemas">
					<li class="item-113 menu-deeper menu-parent">
						<a href="#" class="menu-escolas">Sistemas<span class="menu-toggler"></span></a>
						<ul class="menu-child" style="display: none;"><jdoc:include type="modules" name="offcanvas-sistemas" style="sp_xhtml" /></ul>
					</li>
				</ul>
			</div>
		</div>
