...
/**
 * Methods supporting a list of Rsbebook records.
 *
 * @since  1.0.0
 */
class EbooksModel extends ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$value = 21;//$app->getUserState($this->context . '.list.limit', $app->get('list_limit', 25));
		$list['limit'] = $value;
	...
	protected function getListQuery()
	{
		...
		if (!Factory::getApplication()->getIdentity()->authorise('core.edit', 'com_rsbebook'))
		{
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(Text::_("COM_RSBEBOOK_SEARCH_FILTER_DATE_FORMAT"), "warning");
