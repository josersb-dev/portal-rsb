...
class SppagebuilderAddonRSB_Feature extends SppagebuilderAddons
{
	/**
	...
	public function render()
	{
        ...
        $svg_name = (isset($settings->svg_name) && $settings->svg_name) ? $settings->svg_name : '';
        $svg_bg = (isset($settings->svg_bg) && $settings->svg_bg) ? $settings->svg_bg : '';
       ...
       if($feature_type === 'svg') {
			$media  .= '<div class="sppb-icon icon-csv feature-icon-svg" style="background-color:'.$svg_bg.';">';
            $media .= $svg_name;
			$media .= '</div>';
		}
	...
	public static function getTemplate()
	{
		...
		<#
			...
			let svg_name = data.svg_name.length != "undefined" && data.svg_name ? data.svg_name : "";
		...
		$output .= $lodash->unit('border-width', '.sppb-icon .sppb-icon-container', 'data.icon_border_width');
		$output .= '<# } #>';
		...
		$output .= $lodash->color('color', '', 'data.addon_color');
		...
		// Hover
		$output .= $lodash->color('color', '&:hover', 'data.addon_hover_color');
