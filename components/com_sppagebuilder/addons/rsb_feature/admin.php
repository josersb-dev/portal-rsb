...
SpAddonsConfig::addonConfig([
	'type'       => 'content',
	'addon_name' => 'rsb_feature',
	'title'      => Text::_('RSB Feature Box'),
							...
							'fields' => [
								[
									...
									'icon_name' => [
										...
										'clearable' => false,
										'std'       => 'fas fa-trophy',
										'depends'  => [['feature_type', '!=', 'image'],['feature_type', '!=', 'svg']],
									],
                                    'svg_name' => [
										'type'      => 'textarea',
										'title'     => Text::_('Icone SVG'),
										'clearable' => false,
										'std'       => 'fas fa-trophy',
										'depends'  => [['feature_type', '!=', 'image'],['feature_type', '!=', 'icon']],
									],
									...
									'feature_image' => [
										...
										'depends'  => [['feature_type', '!=', 'icon'],['feature_type', '!=', 'svg']],
									],
