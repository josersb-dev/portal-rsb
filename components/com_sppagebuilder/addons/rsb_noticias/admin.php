...
SpAddonsConfig::addonConfig([
	'type'       => 'repeatable',
	'addon_name' => 'rsb_noticias',
	'category'   => 'RSB',
	'title'      => Text::_('RSB Notícias'),
	'desc'       => Text::_('Exibição de notícias'),
		...
		'rsb_items' => [
			...
			'fields' => [
					'segmento' => [
						...
						'desc'   => Text::_('Categoria de notícia'),
						'values' => getItemsNoticias(),
						'multiple' => true
					],
					'linkvertodas'=>array(
						'type'=>'text',
						'title'=>JText::_('Link Ver Todas'),
						'desc'=>JText::_(''),
						'std'=> ''
					),
				'alignment_separator' => [
...
function getItemsNoticias()
    {
		...
		foreach($results as $result)
		{
			...
			$out[$result->id] = $result->title.$result->level;
